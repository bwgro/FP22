...
# Evakuierungskurve
t, dt, p1, p2, p3, dp = np.genfromtxt('data/dreh_evac.csv', unpack=True)
T = unp.uarray(t,dt)
...
# Leckratenmessung
t05, dt05, p05_1, p05_2, p05_3, dp05 = np.genfromtxt('data/dreh_leck0.5.csv', unpack=True)
t10, dt10, p10_1, p10_2, p10_3, dp10 = np.genfromtxt('data/dreh_leck10.csv', unpack=True)
t50, dt50, p50_1, p50_2, p50_3, dp50 = np.genfromtxt('data/dreh_leck50.csv', unpack=True)
t100, dt100, p100_1, p100_2, p100_3, dp100 = np.genfromtxt('data/dreh_leck100.csv', unpack=True)

# Messdaten Dictionary
dict = {'t': unp.uarray(t05,dt05),
    '0.5': [unp.uarray(p05_1, dp05), unp.uarray(p05_2, dp05), unp.uarray(p05_2, dp05)],
    '10': [unp.uarray(p10_1, dp10), unp.uarray(p10_2, dp10), unp.uarray(p10_2, dp10)],
    '50': [unp.uarray(p50_1, dp50), unp.uarray(p50_2, dp50), unp.uarray(p50_2, dp50)],
    '100': [unp.uarray(p100_1, dp100), unp.uarray(p100_2, dp100), unp.uarray(p100_2, dp100)]}
