...
\subsection{Drehschieberpumpe}
    ...
    $\ln\left(\frac{p-p_E}{p_0-p_E}\right)$, dessen Fehler sich mit dem Fehler des Mittelwertes $\sigma_p$ (\refeq{eq:fehlerDesMittelwertes}) explizit durch \autoref{eq:ln} ausrechnen lässt, sind in \autoref{tab:drehEvacMean} zu sehen.
    \begin{equation}
